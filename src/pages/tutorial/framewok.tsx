		...
		<Container mt={20}>
			<Flex direction={"column"} gap={"md"} align={"center"}>
				...
				<Text align={`center`}>
					...
					использованию, все что нужно - вставить Type-C провод, который шел в комплекте в
					клавиатуру и компьютер.
				</Text>
				...
				<Text align={`center`}>
					...
					клавиатура подключена, то ты увидите примерно вот такой интерфейс.
				</Text>
					...
					<Accordion.Item value={`layer`}>
						...
						<Accordion.Panel>
							<Stack>
								...
								<Text>
									Если нажать на клавишу с рисунком "8", то экране появится цифра. Это
									нулевой слой. Когда мы зажимаем клавишу шифт, то слой переключается и
