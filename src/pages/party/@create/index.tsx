		...
		<Container py={20} px={20}>
			...
			>
				<Text align={`center`} color={`dimmed`} tt={`lowercase`}>
					Листай ниже, чтобы узнать как это работает
				</Text>
			</Container>
			<Flex justify={`center`}>
							...
							<Grid>
								<Grid.Col>
									<Card withBorder p={15}>
										<Grid>
											<Grid.Col>
												<Text>
													Давай представим ситуацию. Ты хочешь устроить вечеринку, будет много
													людей, много еды и развлечений, как стоимость всего честно
								...
								<Grid.Col md={4} sm={12}>
									<Card>
										<Grid>
											<Grid.Col>
												<Text>Состовляем список участников</Text>
											</Grid.Col>

											<Grid.Col>
												<Text>
													В калькуляторе нет ограничение на количество участников. Можешь
								...
								<Grid.Col md={4} sm={12}>
									<Card>
										<Grid>
											...
											<Grid.Col>
												<Text>
													Если выбрано несколько человек, то стоимость разобьется между ними
												</Text>
											</Grid.Col>
										</Grid>
									</Card>
